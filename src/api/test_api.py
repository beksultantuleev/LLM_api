...
def generate():
    ...
    # Calc current size
    print("Context length is currently",
          input_ids.shape[1], "tokens. Allowed amount is", MAX_CONTEXT_LENGTH-ROOM_FOR_RESPONSE, "tokens.")
    ...
    output = model.generate(input_ids, max_length=2048, do_sample=True, early_stopping=True,
                            num_return_sequences=1, eos_token_id=model.config.eos_token_id)
...
if __name__ == '__main__':
    # Set the host to '0.0.0.0' to make it accessible from your local network
